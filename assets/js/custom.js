$(document).ready(function () {
    ...
    contacts = {
        ...
        "Medium": ["medium", "HackerRank", "#00ab6c", "white"],
...
//    var loves = ["making websites", "Sweja", "web designing"];
    ...
    $(function () {
        var hello = ["Coffee", "Making Websites", "Open Source", "Python", "Manchester City FC", "Binge Watching", "JavaScript", "Machine Learning", "Artificial Intelligence"];
        var used = ["Sweja"];
        var greeting = $('#loves');
        var item;
...
//            console.log("j = " + j);
    ...
    $(function () {
        var hello = [" Python", " Java"," PHP", " F#", " HTML + CSS", " C", " C#", " Bash", " SQL", " JavaScript"];
        var used = ["Sweja"];
        var greeting = $('#loves2');
        var item;
...
//        .tiType('and <a href="#" class="special" style="color: black">Quizmaster.</a>')
        ...
        .tiBreak()
        .tiType('<a href="https://www.mcgill.ca/" class="special" style="color: black">McGill University</a>');
});
